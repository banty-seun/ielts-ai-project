...
import {
  Headphones, BookOpen, MessageSquare, Mic,
  Calendar,
  Clock, BarChart,
...
import ListeningWeeklyPlan from '../components/dashboard/ListeningWeeklyPlan';
import QuickPracticeStrip from '../components/dashboard/QuickPracticeStrip';
        ...
        <main className="max-w-5xl mx-auto px-4 py-6 pb-24 md:pb-16">
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-8">
            <div>
              ...
              <div className="flex flex-col md:flex-row md:items-center gap-1 md:gap-3 mt-1">
                ...
                <p className="text-gray-500 flex items-center text-sm">
                  {(() => {
                    const weekdayMinutes = preferences?.listeningDurations?.weekday ?? preferences?.sessionMinutes ?? 20;
                    const weekendMinutes = preferences?.listeningDurations?.weekend;
                    const sessionLabel = weekendMinutes && weekendMinutes !== weekdayMinutes
                      ? `${weekdayMinutes} min weekdays / ${weekendMinutes} min weekends`
                      : `${weekdayMinutes} min`;
                    return (
                      <>
                        <Clock className="h-4 w-4 mr-1" /> Session: {sessionLabel}
                      </>
                    );
                  })()}
                </p>
          ...
          <div className="w-full max-w-4xl mx-auto">
            <div className="w-full">
              ...
              {/* Weekly Study Plan - Listening Focus */}
              <div className="mb-6">
              ...
              <QuickPracticeStrip
                listeningScore={onboardingData?.skillRatings?.listening || 'N/A'}
              />
            </div>
          </div>
        </main>
